...
//            e.printStackTrace();
            throw new RuntimeException(url+"发送 GET 请求出现异常！",e);
        }
        // 使用finally块来关闭输入流
        finally {
            try {
    ...
    public static String sendFormPost(String url, String param,String cookies) {
    	return sendPost(url,param,"",cookies);
    }
    public static String sendJsonPost(String url, String param) {
    	return sendPost(url,param,"application/json;charset=utf-8",null);
    }
    public static String sendJsonPost(String url, String param,String cookies) {
    	return sendPost(url,param,"application/json;charset=utf-8",cookies);
    }
    /**
     * 向指定 URL 发送POST方法的请求
     * 
     ...
     * @return 所代表远程资源的响应结果
     */
    private static String sendPost(String url, String param,String contentType,String cookies) {
...
//            }
            ...
            //e.printStackTrace();
            throw new RuntimeException(url+"发送 POST 请求出现异常！",e);
        }
    ...
    public static String sendPostAndUpload(String urlStr, Map<String, String> textMap,  
        ...
        try {  
            ...
            reader = null;  
        	 ...
        	 throw new RuntimeException(urlStr+"发送 POST 请求出现异常！",e);
        } finally {  
            if (conn != null) {  
                conn.disconnect();  
                conn = null;  
